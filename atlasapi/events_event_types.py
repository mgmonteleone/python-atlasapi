...
class AtlasEventTypes(Enum):
    ...
    PIT_LOGS = 'Pit Logs'
    CPS_BACKUP_LOGS = 'Cps Backup Logs'
    INSIDE_SERVERLESS_METRIC_THRESHOLD = 'Inside Serverless Metric Threshold'
    OUTSIDE_SERVERLESS_METRIC_THRESHOLD = 'Outside Serverless Metric Threshold'
    CLOUD_PROVIDER_THROTTLE_STATE_MODIFIED = 'Cloud Provider Throttle State Modified'
    PROJECT_THROTTLE_STATE_MODIFIED = 'Project Throttle State Modified'
    CLUSTER_THROTTLE_STATE_MODIFIED = 'Cluster Throttle State Modified'
    FORCE_MIGRATE_FROM_AVAILABILITY_SETS = 'Force Migrate From Availability Sets'
    TENANT_CLUSTER_LIMIT_MODIFIED = 'Tenant Cluster Limit Modified'
    SERVERLESS_DEPLOYMENT_UPDATED = 'Serverless Deployment Updated'
    INITIATE_SALESFORCE_SERVICE_CLOUD_SYNC = 'Initiate Salesforce Service Cloud Sync'
    FTS_INDEX_CREATED = 'Fts Index Created'
    FTS_INDEX_UPDATED = 'Fts Index Updated'
    FTS_INDEX_DELETED = 'Fts Index Deleted'
    INITIATE_SFDC_SYNC = 'Initiate Sfdc Sync'
    SERVERLESS_DEPLOYMENT_INSTANCE_REPLACED = 'Serverless Deployment Instance Replaced'
    AWS_BILLING_ACCOUNT_CREDIT_ISSUED = 'AWS Billing Account Credit Issued'
    AWS_USAGE_REPORTED = 'AWS Usage Reported'
    GCP_USAGE_REPORTED = 'GCP Usage Reported'
    SERVERLESS_DEPLOYMENT_INSTANCE_REBOOTED = 'Serverless Deployment Instance Rebooted'
    HOST_MONGOT_CRASHING_OOM_MTM = 'Host Mongot Crashing Oom MTM'
    HOST_MONGOT_RECOVERED_OOM_MTM = 'Host Mongot Recovered Oom MTM'
    SUPPORT_EMAILS_SENT_SUCCESSFULLY = 'Support Emails Sent Successfully'
    PRIVATE_NETWORK_ENDPOINT_ENTRY_ADDED = 'Private Network Endpoint Entry Added'
    PRIVATE_NETWORK_ENDPOINT_ENTRY_REMOVED = 'Private Network Endpoint Entry Removed'
    PRIVATE_NETWORK_ENDPOINT_ENTRY_UPDATED = 'Private Network Endpoint Entry Updated'
    CLUSTER_MONGOT_PROCESS_ARGS_UPDATE_SUBMITTED = 'Cluster Mongot Process Args Update Submitted'
    CLUSTER_SERVER_PARAMETERS_UPDATE_SUBMITTED = 'Cluster Server Parameters Update Submitted'
    M0_CLUSTERS_PER_GROUP_WITHIN_LIMIT = 'M0 Clusters Per Group Within Limit'
    MAX_M0_CLUSTERS_PER_GROUP_EXCEEDED = 'Max M0 Clusters Per Group Exceeded'
    CLUSTER_CONNECTION_CREATE_COLLECTION = 'Cluster Connection Create Collection'
    AUTO_HEALING_ACTION = 'Auto Healing Action'
    SUPPORT_EMAILS_SENT_FAILURE = 'Support Emails Sent Failure'
    EXTRA_MAINTENANCE_DEFERRAL_GRANTED = 'Extra Maintenance Deferral Granted'
    ADMIN_NOTE_UPDATED = 'Admin Note Updated'
    ONLINE_ARCHIVE_RESUMED = 'Online Archive Resumed'
    ONLINE_ARCHIVE_PAUSED_DUE_TO_FRS_JOB_ERRORS_CHECK = 'Online Archive Paused Due To Frs Job Errors Check'
    ORG_ADMIN_LOCKED = 'Org Admin Locked'
    REVOKED_EMPLOYEE_ACCESS_BYPASS = 'Revoked Employee Access Bypass'
    HOST_ENOUGH_DISK_SPACE = 'Host Enough Disk Space'
    HOST_NOT_ENOUGH_DISK_SPACE = 'Host Not Enough Disk Space'
    AWS_SELF_SERVE_ACCOUNT_LINKED = 'AWS Self Serve Account Linked'
    AWS_SELF_SERVE_ACCOUNT_LINK_PENDING = 'AWS Self Serve Account Link Pending'
    AWS_SELF_SERVE_ACCOUNT_CANCELLED = 'AWS Self Serve Account Cancelled'
    AWS_SELF_SERVE_ACCOUNT_LINK_FAILED = 'AWS Self Serve Account Link Failed'
    OS_MAINTENANCE_RESTART = 'Os Maintenance Restart'
    DEVICE_CODE_GENERATED = 'Device Code Generated'
    SUCCESSFUL_DEVICE_CONFIRMATION_AUDIT = 'Successful Device Confirmation Audit'
    GROUP_AUTOMATION_CONFIG_PUBLISHED = 'Group Automation Config Published'
    ...
    SCHEDULE_MANUAL_TRIGGER_REQUESTED = 'Schedule Manual Trigger Requested'
    SCHEDULE_RESUMED = 'Schedule Resumed'
    SCHEDULE_SIDELINED = 'Schedule Sidelined'
    ...
    TENANT_ENDPOINT_DELETING = 'Tenant Endpoint Deleting'
    TENANT_ENDPOINT_DELETED = 'Tenant Endpoint Deleted'
    ORG_DISCONNECTED_TO_VERCEL = 'Org Disconnected To Vercel'
    ONLINE_ARCHIVE_DATA_EXPIRATION_RULE_ENABLED = 'Online Archive Data Expiration Rule Enabled'
    ONLINE_ARCHIVE_DATA_EXPIRATION_RULE_UPDATED = 'Online Archive Data Expiration Rule Updated'
    ONLINE_ARCHIVE_DATA_EXPIRATION_RULE_DISABLED = 'Online Archive Data Expiration Rule Disabled'
    GCP_SELF_SERVE_ACCOUNT_CANCELLED = 'GCP Self Serve Account Cancelled'
    INGESTION_PIPELINE_DELETED = 'Ingestion Pipeline Deleted'
    OS_TUNE_FILE_OVERRIDES = 'Os Tune File Overrides'
